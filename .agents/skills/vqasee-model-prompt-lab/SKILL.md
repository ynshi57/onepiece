...
9. 不能输出“可以开/可以走”的确定承诺；只能表达风险、疑似边界、建议放慢、请自行确认。
...
- 自动路由：按模式和设备能力选择；
- 更强模型、本地感知模型或混合方案：当 Qwen 3B/7B 对核心场景、障碍物、路面边界、人行横道/车道线能力不足时评估。
...
- walking / riding / driving-risk 模式优先低延迟模型，但安全风险、边界和交通线索识别不能明显倒退；
